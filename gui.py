...
class ChessWindow(QWidget):
    ...
    def toggle_training(self):
        if self.btn_train.isChecked():
            ...
            # Call our reusable start function
    ...
    def start_new_training_round(self):
        """Resets the board and starts a fresh training line."""
        self.board.reset()
        self.board_widget.update_board()
    ...
    def on_board_move(self, move):
        if self.is_training:
            ...
            if is_correct:
                ...
                if comment:
                    self.console_output.append(f"Coach: {comment}")
    ...
    def computer_reply_turn(self):
        ...
        if reply:
            ...
            # --- LOOP LOGIC: Restart immediately after closing the box ---
            self.start_new_training_round()
